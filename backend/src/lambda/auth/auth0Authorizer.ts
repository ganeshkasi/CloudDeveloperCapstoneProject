...
// RECEIPT: Provide a URL that can be used to download a certificate that can be used
// to verify JWT token signature.
// To get this URL you need to go to an Auth0 page -> Show Advanced Settings -> Endpoints -> JSON Web Key Set
const jwksUrl = 'https://dev-56kp3cuf.us.auth0.com/.well-known/jwks.json'
const topicARN = process.env.RECEIPT_TOPIC_ARN
const sns = new XAWS.SNS({apiVersion: '2010-03-31'})
...
async function verifyToken(authHeader: string): Promise<JwtPayload> {
  ...
  // RECEIPT: Implement token verification
